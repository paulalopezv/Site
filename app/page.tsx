      ...
      <section className="research-section" aria-labelledby="working-papers">
        ...
        <article className="publication">
          ...
          <details className="abstract">
            <summary>Abstract</summary>
            <p>
              This paper studies the effects of coca cultivation on local development in Peru between 2004 and 2017. To address endogeneity, we exploit plausibly exogenous variation in coca exposure generated by the interaction of local agro-climatic suitability with lagged coca production in Colombia and Bolivia. We combine annual geo-referenced coca maps with satellite-based night-time lights, household surveys, agricultural and prison census records, and administrative and electoral data. We find that coca exposure increases local economic activity, household income, consumption, and wages. Complementary evidence from prison census records shows that coca-growing districts have higher incarceration-linked crime, with the most consistent associations concentrated in drug-related offenses rather than violent or property crime. We also find that coca-growing areas are substantially more likely to be subdivided into new districts, alongside more suggestive evidence of changes in local electoral competition and political succession. Our findings show that coca generates meaningful local economic gains in areas with limited outside opportunities, while also shaping patterns of criminal activity and the organization of local government.
            </p>
          </details>
        </article>
        <article className="publication">
